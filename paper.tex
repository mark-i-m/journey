...
of all accesses done after swapping starts. However, Figure (TODO: figure) shows
that these few accesses form a majority of run time; they impact performance
significantly. (TODO: why do they happen).
...
seeks when paging out.

~\\ \textbf{Conclusions} TODO
