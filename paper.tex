...
\subsubsection{Time (TODO: HP/MARKM)}
...
\begin{figure}
    ...
    Notice that the y-axis scale is from 93\% to 100\%.}
\end{figure}
...
\begin{figure}
    ...
    Notice that the y-scale is logarithmic.}
\end{figure}

\begin{figure}
    \includegraphics[width=\columnwidth]{figures/swap_time_rand}
    \caption{Time to touch a page while swapping for random benchmark.}
\end{figure}
