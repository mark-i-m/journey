...
We find that although kswapd does not take up a significant
percentage of runtime compared with the applcation, it does still take
siginficant amounts of time and use system resources. This is especially true
during times of high memory pressure.

We also found that kswapd's behavior heavily depends on whether huge pages are
enabled or not.
