...
$2^{20}$ contiguous 4KB blocks. Then, it resizes every other block to
16KB. This represents the worst case behavior we could think of. It requires the
kernel to find a block it has not touched in $2^{20}$ operations and move
it somewhere else.  
\end{itemize}
