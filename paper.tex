...
tree is needed, possibly including rebalancing. Moreover, the exisiting texttt{
vm\_area\_struct} might need to be deleted and removed from the tree. All of these
operations ensure that frag mmap pattern takes the most amount of time. 
...
struct and insert it into red-black tree. Therefore, most of the times the time 
taken by rand benchmark is lower than strided. 
