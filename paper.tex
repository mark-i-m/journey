...
TODO: memory results: SPAI

TODO: time results: HP
...
\begin{figure}
    ...
    \caption{CDF Time to touch a page while swapping for continuous benchmark}
\end{figure}
\begin{figure}
    \includegraphics[width=\columnwidth]{figures/swap_touch_time_rand_cdf}
    \caption{CDF Time to touch a page while swapping for random benchmark}
\end{figure}
